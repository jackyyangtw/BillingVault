...
4. Generate updated comments.
   ...
   - **Inline Comments**: Explain _why_ something is done, not just _what_ is done. Remove obvious comments.
   - **Tone**: Keep it professional and concise.
   - **Language**: All comments must be written in Traditional Chinese (繁體中文).
5. Apply the updates.
